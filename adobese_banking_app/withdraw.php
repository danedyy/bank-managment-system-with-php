<?php
    ...
    if(isset($_POST["withdraw"])){
       ...
       if($new_balance<1000){
        //cannot withdraw
        header("Location:withdraw.php?resp");
    }
    else{
       ...
       $res =mysqli_query($connect, $sql) or die(mysqli_error($connect));
        ...
        $tquery ='INSERT INTO transactions(account_no,type, amount ,date) VALUES('.$account_no.', "withdraw", '.$amount.', now())';
            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                            <?php echo "withdraw:"." ".$account_name . " - " . $account_no; ?>
                       <h4 class="gen-case">
                        ...
                        <div class="compose-mail">
                            ...
                            <?php
                            if(isset($_GET["resp"])){
                                echo '<div class=alert alert-dnger fade in><strong>Insufficient fund in client account</strong></div>';
                            }
                            ...
                            ?>
                                ...
                                <div class="compose-btn">
                                    <button class="btn btn-primary btn-sm" type="submit" name="withdraw" ><i class="fa fa-check" ></i>Withdraw</button>
                                </div>
